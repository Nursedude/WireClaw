...
| `pr/display-status-screen` | upstream PR (a) | feature code lives HERE; fix review feedback HERE |
| `pr/nats-token-auth` | upstream PR (b) | feature code lives HERE; fix review feedback HERE |
...
git merge --no-edit pr/display-status-screen pr/nats-token-auth   # all open pr/* branches
