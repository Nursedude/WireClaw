...
| `pr/lora-mesh-voice` | fork-first (stacked ON pr/lora-mesh-ears) | mesh_send TX + mesh_set_channel (runtime name+PSK); secret-safe (public default, private channel runtime-only); airtime-guarded |
