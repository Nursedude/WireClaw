...
void led(uint8_t r, uint8_t g, uint8_t b) {
...
#ifdef DUDECLAW_WHITE_LED
    /* dude-claw fork: Heltec V4 has no WS2812 — the generic devkit's
    ...
    pinMode(DUDECLAW_WHITE_LED, OUTPUT);
    analogWrite(DUDECLAW_WHITE_LED, max(r, max(g, b)));
...
void setup() {
    ...
    /* Status display (dude-claw fork; no-op on builds without DUDECLAW_OLED).
